...
public enum ResultadoTDHA {
    NO_DETECTADO("No se Detectan Indicios de TDHA. Tras completar el test, " +
    ...
    ALGUNOS_INDICIOS("Se Observan Algunos Indicios que Podrían Ser Indicativos de TDHA. " +
    ...
    ALTA_PROBABILIDAD("Los Resultados Sugieren una Alta Probabilidad de TDHA. Basándose en los " +
