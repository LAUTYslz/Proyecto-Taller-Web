...
CREATE TABLE ModeloTest (
                            id BIGINT AUTO_INCREMENT PRIMARY KEY,
                            nombreTest VARCHAR(100) NOT NULL,
                            descripcionTest VARCHAR(100) NOT NULL
);
...
CREATE TABLE PreguntaTest (
                              id BIGINT AUTO_INCREMENT PRIMARY KEY,
                              texto VARCHAR(255),
                              modeloTest_id BIGINT,
                              FOREIGN KEY (modeloTest_id) REFERENCES ModeloTest(id)
);
